	...
	return (
		...
		>
				...
				{!isSubmitted ? (
					<form onSubmit={handleSubmit}>
						...
						<motion.button
							...
							whileTap={{ scale: 0.98 }}
							className='w-full py-3 px-4 bg-[#E94B3CFF] text-white font-bold rounded-lg shadow-lg hover:bg-[#2D2926FF] focus:outline-none focus:ring-2 focus:ring-[#E94B3CFF] focus:ring-offset-2 focus:ring-offset-[#2D2926FF] transition duration-200'
							type='submit'
						>
					...
					<div className='text-center'>
						<motion.div
							...
							className='w-16 h-16 bg-[#E94B3CFF] rounded-full flex items-center justify-center mx-auto mb-4'
						>
			...
			<div className='px-8 py-4 bg-[#2D2926FF] bg-opacity-50 flex justify-center'>
				<Link to={"/login"} className='text-sm text-[#E94B3CFF] hover:underline flex items-center'>
